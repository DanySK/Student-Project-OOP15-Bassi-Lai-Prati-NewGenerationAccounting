...
public enum Sections implements IDataEnum{  //insieme di tutte le sezioni di SP e CE
    //ATTIVITA'
    CREDITI_VS_SOCI, IMMOBILIZZAZIONI_IMMATERIALI, IMMOBILIZZAZIONI_MATERIALI, IMMOBILIZZAZIONI_FINANZIARIE,
    RIMANENZE, CREDITI, ATTIVITA_FINANZIARIE, DISPONIBILITA_LIQUIDE, RATEI_E_RISCONTI_ATTIVI,
    //PASSIVITA'
